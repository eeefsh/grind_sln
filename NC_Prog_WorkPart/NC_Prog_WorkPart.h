...
*	******************使用模板的说明*****************
* 
*	1、替换解决方案中所有的 “NC_Prog_WorkPart” 为 自定义的项目名
...
/*  ****************** 引用额外的库的说明 ******************
*	
*	1、本项目模板默认包含NC_Prog_WorkPart的设置作为实例，如下
*	2、请参照NC_Prog_WorkPart_settings.h文件内容和安置路径设置其他库
*	3、可能还需要进行一些手动操作，详情见xt_armadillo_settings.h中说明
*	4、将上一层相关库关联信息代码复制到 生成后事件
*/

//#include "maneger_h/NC_Prog_WorkPart_settings.h"
