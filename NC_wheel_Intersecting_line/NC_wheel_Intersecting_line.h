...
*	******************使用模板的说明*****************
* 
*	1、替换解决方案中所有的 “NC_wheel_Intersecting_line” 为 自定义的项目名
...
/*  ****************** 引用额外的库的说明 ******************
*	
*	1、本项目模板默认包含NC_wheel_Intersecting_line的设置作为实例，如下
*	2、请参照NC_wheel_Intersecting_line_settings.h文件内容和安置路径设置其他库
