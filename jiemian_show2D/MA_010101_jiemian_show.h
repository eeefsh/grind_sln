...
copy "$(xt_vc_import_dir)\jiemian_show\lib\$(Platform)\$(Configuration)\*.lib" "$(OutDir)*.lib"
copy "$(xt_vc_import_dir)\jiemian_show\bin\$(Platform)\$(Configuration)\*.dll" "$(OutDir)*.dll"
...
//设置包含的头文件
#include "jiemian_show\include\jiemian_show.h"
...
#ifdef xt_WIN32
	#ifdef _DEBUG
		#pragma comment(lib, "jiemian_show\\lib\\win32\\debug\\jiemian_show.lib")
	#else
		#pragma comment(lib, "jiemian_show\\lib\\win32\\release\\jiemian_show.lib")
	#endif
#else
	#ifdef _DEBUG
		#pragma comment(lib, "jiemian_show\\lib\\x64\\debug\\jiemian_show.lib")
	#else
		#pragma comment(lib, "jiemian_show\\lib\\x64\\release\\jiemian_show.lib")
	#endif
#endif
