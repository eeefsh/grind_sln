...
copy "$(xt_vc_import_dir)\NC_RotateShow\lib\$(Platform)\$(Configuration)\*.lib" "$(OutDir)*.lib"
copy "$(xt_vc_import_dir)\NC_RotateShow\bin\$(Platform)\$(Configuration)\*.dll" "$(OutDir)*.dll"
...
//设置包含的头文件
#include "NC_RotateShow\include\NC_RotateShow.h"
...
#ifdef xt_WIN32
	#ifdef _DEBUG
		#pragma comment(lib, "NC_RotateShow\\lib\\win32\\debug\\NC_RotateShow.lib")
	#else
		#pragma comment(lib, "NC_RotateShow\\lib\\win32\\release\\NC_RotateShow.lib")
	#endif
#else
	#ifdef _DEBUG
		#pragma comment(lib, "NC_RotateShow\\lib\\x64\\debug\\NC_RotateShow.lib")
	#else
		#pragma comment(lib, "NC_RotateShow\\lib\\x64\\release\\NC_RotateShow.lib")
	#endif
#endif
