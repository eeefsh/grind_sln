...
class AFX_EXT_CLASS dialog_Jianjiao_shalun : public CDialogEx
{
	DECLARE_DYNAMIC(dialog_Jianjiao_shalun)

public:
	dialog_Jianjiao_shalun(CWnd* pParent = nullptr);   // 标准构造函数
	virtual ~dialog_Jianjiao_shalun();

// 对话框数据
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_DIALOG_Jianjiao_shalun };
#endif
...
private:
	...
	wheel_dialog_namespace::canshu_Jianjiao_shalun canshu;
	void auto_show();
	//初始化界面参数
	void init_canshu();
	void updata_show();
