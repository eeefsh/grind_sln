...
copy "$(xt_vc_import_dir)\NC_wheel_data\lib\$(Platform)\$(Configuration)\*.lib" "$(OutDir)*.lib"
copy "$(xt_vc_import_dir)\NC_wheel_data\bin\$(Platform)\$(Configuration)\*.dll" "$(OutDir)*.dll"
...
//设置包含的头文件
#include "NC_wheel_data\include\NC_wheel_data.h"
...
#ifdef xt_WIN32
	#ifdef _DEBUG
		#pragma comment(lib, "NC_wheel_data\\lib\\win32\\debug\\NC_wheel_data.lib")
	#else
		#pragma comment(lib, "NC_wheel_data\\lib\\win32\\release\\NC_wheel_data.lib")
	#endif
#else
	#ifdef _DEBUG
		#pragma comment(lib, "NC_wheel_data\\lib\\x64\\debug\\NC_wheel_data.lib")
	#else
		#pragma comment(lib, "NC_wheel_data\\lib\\x64\\release\\NC_wheel_data.lib")
	#endif
#endif
